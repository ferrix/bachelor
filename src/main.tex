...
\YEAR{2011}
\DATE{17. kesäkuuta 2011}
\ENDATE{June 17, 2011}

% Kurssin vastuuopettaja ja työsi ohjaaja(t)
\SUPERVISOR{Ma professori Tomi Janhunen}
\INSTRUCTOR{TkT Ari Korhonen}

\ENSUPERVISOR{Professor (tem) Tomi Janhunen}
\ENINSTRUCTOR{D.Sc. (Tech) Ari Korhonen}

\PAAAINE{Ohjelmistotuotanto ja -liiketoiminta}
\CODE{T3003}

\KEYWORDS{staattinen analyysi, automaattinen arvostelu, turvallisuus, turvallisuusriski}
\ENKEYWORDS{static analysis, CAA, computer aided assesment}
